...
GLuint compile_shader(const char* shader_file, GLenum shader_type){
    ...
    const GLchar* content = temp.c_str();
...
int main()
{
    ...
    // ------------------------------------
    // vertex shader
    unsigned int vertexShader = compile_shader("../shader.vert", GL_VERTEX_SHADER);
    // fragment shader
    unsigned int fragmentShader = compile_shader("../shader.frag", GL_FRAGMENT_SHADER);
    // link shaders
